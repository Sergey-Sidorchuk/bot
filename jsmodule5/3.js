...
// Всё это нужно сделать динамически, во время выполнения программы.Для этого используют функции - конструкторы, вызывая их при помощи специального оператора new.
...
// То есть this внутри функции будет ссылаться на новосозданный объект.
...
const model1 = new Car('Audi', 'Q3', 36000);
console.log(model1);

const model2 = new Car('BMW', 'X5', 58900);
console.log(model2);

const model3 = new Car('Nissan', 'Murano', 31700);
console.log(model3);
