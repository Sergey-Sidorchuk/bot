...
// Метод Object.create(obj) создаёт и возвращает новый объект, связывая его с объектом obj.Объект, 
// на который указывает ссылка в __proto__, называется прототипом.
...
parent.isPrototypeOf('heritage');
parent.isPrototypeOf('surname');
parent.isPrototypeOf('age');
parent.isPrototypeOf('name');
